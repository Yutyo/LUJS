...
class CharData {
     ...
     * @param mouthStyle
     */
    setMinifigureData(hairColor, hairStyle, shirtColor, pantsColor, leftHand, rightHand, eyebrowStyle, eyeStyle, mouthStyle) {
    ...
    setDestructibleInformation(healthMaximum, healthCurrent, imaginationMaximum, imaginationCurrent, armorMaximum, armorCurrent) {
