                ...
                object.addSerializer(SerializationOrder.indexOf(Components.CONTROLABLE_PHYSICS_COMPONENT), (type, stream) => {
                    ...
                    if(data.positionData !== undefined) {
                        ...
                        if(data.positionData.movingPlatformData !== undefined) {
                            ...
                            stream.writeFloat(data.positionData.movingPlatformData.unknown2);
                            stream.writeFloat(data.positionData.movingPlatformData.unknown3);
                            stream.writeBit(data.positionData.movingPlatformData.moreUnknown !== undefined);
                            if(data.positionData.movingPlatformData.moreUnknown !== undefined) {
                                stream.writeFloat(data.positionData.movingPlatformData.moreUnknown.unknown1);
                                stream.writeFloat(data.positionData.movingPlatformData.moreUnknown.unknown2);
                                stream.writeFloat(data.positionData.movingPlatformData.moreUnknown.unknown3);
                            }
                        }
                    }
